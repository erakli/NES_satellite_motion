...
type
  ...
  private
    ...
    Fa: array [0 .. FA_SIZE] of MType;
    // t is measured in Julian centuries of TDB
...
procedure TCIP_Tranform_Matrix.FaInit(t: MType);
// t is measured in Julian centuries
var
  l, l_, F, D, Om: MType;
begin
...
//  non_pol := 0;
  // результат вычисления - МИКРОарксекунды (надо переводить к арксекундам)
...
begin
  ...
  // в МИКРОарксекундах
  pol := -6951 - 25896 * t - 22407274.7 * pow2(t) + 1900.59 * pow3(t) + 1112.526
    * pow4(t) + 0.1358 * pow5(t);
...
begin
  ...
  // в МИКРОарксекундах
  pol := 94.0 + 3808.65 * t - 122.68 * pow2(t) - 72574.11 * pow3(t) + 27.98 *
    pow4(t) + 15.62 * pow5(t);
