...
//    function getResult: TMatrix;
  ...
  public
    ...
    function getRight(X: PDVector; t: MType): TDVector;

    // заглушка
    //bool Stop_Calculation(TYPE t, TYPE Step, TDVector &PrevStep, TDVector &CurStep){ return false; };
  end;
